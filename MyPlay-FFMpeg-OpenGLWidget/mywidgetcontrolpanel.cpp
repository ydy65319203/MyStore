...
CMyWidgetControlPanel::CMyWidgetControlPanel()
{
    ...
    //连接信号槽
    connect(m_pMyOpenGLWidget, &MyOpenGLWidget::sig_updatePlayState, this, &CMyWidgetControlPanel::OnVideoPlayState);
    connect(m_pMyAudioOutput, &CMyAudioOutput::signal_updatePlayState, this, &CMyWidgetControlPanel::OnAudioPlayState);
    ...
    connect(m_pPushButton_Play, &QPushButton::clicked, this, &CMyWidgetControlPanel::OnButton_Play);
    connect(m_pPushButton_OpenFile, &QPushButton::clicked, this, &CMyWidgetControlPanel::OnButton_OpenFile);
...
MyOpenGLWidget *CMyWidgetControlPanel::getMyOpenGLWidget()
{
    return m_pMyOpenGLWidget;
}

//void CMyWidgetControlPanel::setFFmpeg(CMyFFmpeg *pMyFFmpeg)
//{
//    LOG(Info, "CMyWidgetControlPanel::setFFmpeg( pMyFFmpeg = %p )... \n", pMyFFmpeg);
//    m_pMyFFmpeg = pMyFFmpeg;
//}

void CMyWidgetControlPanel::OnVideoPlayState(int iState)
{
    LOG(Info, "CMyWidgetControlPanel::OnVideoPlayState( iState=%d )... \n", iState);
    ...
    if (m_pPushButton_Play)
    {
        ...
        {
        case enClose:
            LOG(Info, "CMyWidgetControlPanel::OnVideoPlayState()---> m_pPushButton_Play->setStyleSheet(NULL), setEnabled(false); \n");
        ...
        case enPlay:
            //播放时，显示暂停按钮。
            LOG(Info, "CMyWidgetControlPanel::OnVideoPlayState()---> m_pPushButton_Play->setStyleSheet( border-image: pause.png ); \n");
            m_pPushButton_Play->setStyleSheet("border-image: url(:/picture/pause.png);");
            break;

        case enPause:
            //暂停时，显示播放按钮。
            LOG(Info, "CMyWidgetControlPanel::OnVideoPlayState()---> m_pPushButton_Play->setStyleSheet(NULL); \n");
            m_pPushButton_Play->setStyleSheet("");
            break;
...
void CMyWidgetControlPanel::OnAudioPlayState(int iState)
{
    LOG(Info, "CMyWidgetControlPanel::OnAudioPlayState( iState=%d )... \n", iState);
    ...
    if (m_pPushButton_Play)
    {
        ...
        {
        case enClose:
            LOG(Info, "CMyWidgetControlPanel::OnAudioPlayState()---> m_pPushButton_Play->setStyleSheet(NULL), setEnabled(false); \n");
            m_pPushButton_Play->setStyleSheet("");
            m_pPushButton_Play->setEnabled(false);
            break;
        ...
        case enPlay:
            //播放时，显示暂停按钮。
            LOG(Info, "CMyWidgetControlPanel::OnAudioPlayState()---> m_pPushButton_Play->setStyleSheet(border-image: pause.png); \n");
            m_pPushButton_Play->setStyleSheet("border-image: url(:/picture/pause.png);");
            break;

        case enPause:
            //暂停时，显示播放按钮。
            LOG(Info, "CMyWidgetControlPanel::OnAudioPlayState()---> m_pPushButton_Play->setStyleSheet(NULL); \n");
            m_pPushButton_Play->setStyleSheet("");
            break;
...
void CMyWidgetControlPanel::OnButton_OpenFile()
{
...
void CMyWidgetControlPanel::OnButton_Play()
{
...
//响应定时器事件
void CMyWidgetControlPanel::timerEvent(QTimerEvent *event)
{
...
void CMyWidgetControlPanel::openYUVFile(QString &qstrFileName)
{
...
//ds_480x272.yuv
void CMyWidgetControlPanel::parseYUVFileName(QString &qstrFileName, int &iWidth, int &iHeight)
{
    //截取480x272
    QString qstrPixelSize = qstrFileName.mid(qstrFileName.lastIndexOf("_")+1);
    qstrPixelSize.truncate(qstrPixelSize.lastIndexOf(".yuv"));
...
void CMyWidgetControlPanel::playYUVFrame()
{
